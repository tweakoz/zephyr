...
#define _NET_ETHERNET_CODE	0x802
...
enum net_request_ethernet_cmd {
	...
	NET_REQUEST_ETHERNET_CMD_SET_QAV_DELTA_BANDWITH,
...
#define NET_REQUEST_ETHERNET_SET_QAV_DELTA_BANDWITH				\
	(_NET_ETHERNET_BASE | NET_REQUEST_ETHERNET_CMD_SET_QAV_DELTA_BANDWITH)

NET_MGMT_DEFINE_REQUEST_HANDLER(NET_REQUEST_ETHERNET_SET_QAV_DELTA_BANDWITH);
