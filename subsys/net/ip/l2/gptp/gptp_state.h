...
/* Sync Receive state machine variables. */
...
/* Sync Send state machine variables. */
...
/* Port Sync Sync Receive state machine variables. */
struct gptp_pss_rcv_state {
	...
	struct k_timer sync_receipt_timeout_timer;
	...
	bool sync_receipt_timeout_timer_expired;
};

/* Port Sync Sync Send state machine variables. */
...
/* Site Sync Sync state machine variables. */
...
/* Clock Slave Sync state machine variables. */
...
/* Clock Master Sync state machine variables. */
...
/* Port Announce Receive state machine variables. */
...
/* Port Role Selection state machine variables. */
struct gptp_port_role_selection_state {
	enum gptp_pr_selection_states state;
};

/**
 * @brief Port Announce Transmit state machine variables.
 */
